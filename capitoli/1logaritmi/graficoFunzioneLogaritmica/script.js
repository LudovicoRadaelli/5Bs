var ggbApp1 = new GGBApplet({
    ...
    "filename":"img/costruzioneGraficoLogaritmoBase2.ggb"}, 
    true);   
...
var ggbApp2 = new GGBApplet({
    ...
    "enableShiftDragZoom": false,
    "scaleContainerClass":"geogebra-container",
    "filename":"img/costruzioneGraficoLogaritmoBase1su2.ggb"}, 
    true);   
...
var ggbApp3 = new GGBApplet({
    ...
    "enableShiftDragZoom": false,
    "scaleContainerClass":"geogebra-container",
    "filename":"img/funzioneLogarimicaBaseVariabile.gbb.ggb"}, 
    true);   
